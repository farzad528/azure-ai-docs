...
To maximize the accuracy of knowledge base invocations and ensure proper citation formatting, use optimized agent instructions. Based on Applied Science experiments, we recommend the following instruction template as a starting point:
